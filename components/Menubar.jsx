...
const Menubar = () => {
  return (
    <div className="md:flex flex-col gap-2 items-start justify-start w-[60px]  md:w-full rounded-2xl bg-cblack   ">
      <div className="relative  w-full ">
        <div className="flex gap-3  items-center justify-start h-16">
          ...
          <span className="text-cwhite items-center font-akaya md:inline lg:text-xl md:text-base hidden">
            Home
          </span>
        </div>
      </div>
      <div className="relative  bg-cdark  w-full ">
        <div className="flex gap-3 before:block before:w-2 before:absolute before:bg-cprimary before:rounded-tl-2xl before:rounded-bl-2xl  before:h-[100%] items-center justify-start h-16">
          ...
          <span className="text-cprimary items-center font-akaya md:inline lg:text-xl md:text-base hidden">
            Explore
          </span>
        </div>
      </div>
